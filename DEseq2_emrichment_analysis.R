...
setwd("/Users/shahadsaeed/Desktop/rd/DEseq2_EA") #Path_to_working_directory


rawcount<-read.table ("input.csv",header=TRUE,  sep=",",  row.names=1)
...
anno <-read.table ("Annotation_of_samples.csv",header=TRUE,  sep=",", row.names = 1) ##In this case we have 3 coulmns (a) sample (b) Condition (c) batch
